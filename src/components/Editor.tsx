...
export function Editor({ 
  ...
  const fontItems: ToolbarDropdownItem[] = [
    ...
    { type: 'divider' },
    { type: 'header', label: 'World scripts' },
    { label: 'Noto Sans JP', onClick: () => applyFontFamily('"Noto Sans JP", sans-serif'), active: fontFamily.includes('Noto Sans JP'), style: { fontFamily: '"Noto Sans JP", sans-serif' } },
    { label: 'Noto Sans SC', onClick: () => applyFontFamily('"Noto Sans SC", sans-serif'), active: fontFamily.includes('Noto Sans SC'), style: { fontFamily: '"Noto Sans SC", sans-serif' } },
    { label: 'Noto Sans KR', onClick: () => applyFontFamily('"Noto Sans KR", sans-serif'), active: fontFamily.includes('Noto Sans KR'), style: { fontFamily: '"Noto Sans KR", sans-serif' } },
    { label: 'Noto Sans Thai', onClick: () => applyFontFamily('"Noto Sans Thai", sans-serif'), active: fontFamily.includes('Noto Sans Thai'), style: { fontFamily: '"Noto Sans Thai", sans-serif' } },
    { label: 'Noto Sans Arabic', onClick: () => applyFontFamily('"Noto Sans Arabic", sans-serif'), active: fontFamily.includes('Noto Sans Arabic'), style: { fontFamily: '"Noto Sans Arabic", sans-serif' } },
    { label: 'Noto Sans Devanagari', onClick: () => applyFontFamily('"Noto Sans Devanagari", sans-serif'), active: fontFamily.includes('Noto Sans Devanagari'), style: { fontFamily: '"Noto Sans Devanagari", sans-serif' } },
    { type: 'divider' },
